...
""",
    ...
    # 👉 여기부터는 윤유정님이 준 문구 그대로
    st.markdown(
        """
🔹 <b>특정가스사용시설 [도시가스사업법 시행규칙 【별표7】]</b><br><br>

1) 산업통상부령으로 정하는 가스사용시설로 월사용 예정량 2,000㎥ 이상  
&nbsp;&nbsp;&nbsp;&nbsp;(제1종 보호시설은 1,000㎥ 이상) <br>
2) 월 사용예정량이 2,000㎥ (제1종보호시설 안에 있는 경우에는 1,000㎥) 미만인 가스사용시설 중에서<br>
&nbsp;&nbsp;&nbsp;&nbsp;① 내관 및 그 부속시설이 바닥ㆍ벽 등에 매립 또는 매몰 설치되는 가스사용시설  
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(가정용 가스사용시설은 제외한다) <br>
&nbsp;&nbsp;&nbsp;&nbsp;② 많은 사람이 이용하는 시설로서 시ㆍ도지사가 안전관리를 위하여 필요하다고 인정하여 지정하는 가스사용시설<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(예: 학원, 유치원, 유아원, 놀이방, 어린이집 등)

<br>

🔹 <b>월사용 예정량 산출식 (도시가스사업법 시행규칙 【별표7】)</b><br><br>

Q = [(A × 240) + (B × 90)] ÷ 11,000 kcal/m³<br>
Q : 월사용 예정량 (m³)<br>
A : 산업용으로 사용하는 연소기의 명판에 기재된 가스소비량의 합계 (단위 : ㎉/h)<br>
B : 산업용이 아닌 연소기의 명판에 기재된 가스소비량의 합계 (단위 : ㎉/h)<br>
※ 단, 가정용으로 사용하는 연소기의 가스소비량은 합산 대상에서 제외<br>
※ 산업용 : 판매를 목적으로 하는 제품을 생산하는데 사용되는 가스 연소기<br>
※ 비산업용 : 산업용 이 외의 모든 가스 연소기<br>

<br>

🔹 <b>제1종 보호시설 [도시가스사업법 시행규칙 【별표1】]</b><br><br>

학교, 유치원, 어린이집, 어린이놀이시설, 경로당, 청소년수련시설,<br>
병원 및 병원급 의료기관, 학원, 도서관, 전통시장, 숙박업, 목욕시설,<br>
영화상영관, 종교시설, 장례식장 등<br>
사실상 독립된 부분의 연면적 1,000㎡ 이상 건축물<br>
공연장, 예식장, 전시장에 해당되는 수용능력 300인 이상 시설<br>
...
"""
    ...
    with colB:
        st.write("상업용 : (입력값) × 240시간 ÷ 11,000 kcal/m³")
        st.write("일반용 : (입력값) × 90시간 ÷ 11,000 kcal/m³")
