...
1) 월사용 예정량 2,000㎥ 이상(제1종 보호시설은 1,000㎥ 이상)  
2) 사용예정량이 기준 미만이더라도 시·도지사 지정 시설
...
- Q : 월사용 예정량 (m³)<br>
- A : 산업용 연소기 가스소비량 합계 (kcal/h)<br>
- B : 비산업용 연소기 가스소비량 합계 (kcal/h)<br>
...
🔹 <b>제1종 보호시설 주요 예시</b><br>
학교·어린이집·노인시설·병원·학원·시장·숙박·목욕·영화관·종교시설 등
""",
        unsafe_allow_html=True
    )
