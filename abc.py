...
- 시간당 증발량 2톤 이상, 또는 시간당 열량 1,238,000 kcal/h 이상  
  → 대기오염물질배출시설 해당
...
""",
    ...
    st.markdown(
        """
<h3 style="font-size:18px; font-weight:600;">※ 타장비 : 캐스케이드 제품 외 보일러, 온수기, 흡수식·냉온수기 등</h3>
""",
        unsafe_allow_html=True
    )
...
"""
    ...
    if st.button("특정가스사용시설 판별", key="gas_judge"):
        ...
        threshold = 1_000 if facility_type == "제1종 보호시설" else 2,000
